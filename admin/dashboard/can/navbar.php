                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Eléments du navbar </h5>
                                                    </div>
                                                    <div class="card-block">
                                                        <h4 class="sub-title">Modifiez le contenu des éléments si désiré</h4>
                                                        ...
                                                        include_once('../../../Controllers/getNavbar.php');
                                                            ...
                                                            echo "</div>";
                                                            echo "<div class=\"form-group row\">";
                                                                echo "<label class=\"col-sm-2 col-form-label\">Slogan (max = 100 caractères) </label>";
                                                                echo "<div class=\"col-sm-10\">";

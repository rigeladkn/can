                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    <img class="img-80 img-radius" src="../../../assets/dashboard/images/avatar-4.jpg" alt="User-Profile-Image">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="acceuil.php" class="waves-effect waves-dark">
                                        ...
                                        <li class=" ">
                                            <a href="lecan.php" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">Le CAN</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class="">
                                        ...
                                        <li class=" ">
                                            <a href="partenaires.php" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <div class="pcoded-navigation-label">Site web</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                                    <a href="http://localhost/can/" target="blank" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-receipt"></i><b>FC</b></span>
                                        <span class="pcoded-mtext">Aller sur le site web</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                            </ul>

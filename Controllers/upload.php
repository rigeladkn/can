...
if(isset($_POST["submit"]) && isset($_POST["title"]) && isset($_POST["description"])) {
  ...
  if($check !== false) {
    ...
    header("location: http://localhost/can/admin/dashboard/can/acceuil.php?success=notimage");
    die();
    $uploadOk = 0;
  }
    ...
    $uploadOk = 0;
    header("location: http://localhost/can/admin/dashboard/can/acceuil.php?success=exist");
    die();
    }
    ...
    $uploadOk = 0;
    header("location: http://localhost/can/admin/dashboard/can/acceuil.php?success=sizetoolong");
    die();
    }
